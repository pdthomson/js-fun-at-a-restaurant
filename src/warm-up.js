...
var shouldOrderMore = if (inStock < 20) {
  return true;
} else {
  return false;
}
...
function stockChecker(stockCount) {
  if (stockCount >= 1) {
...
var vegetables = ['carrots', 'lettuce', 'broccoli', 'spinach', 'squash']
var vegetables = ['carrots', 'lettuce', 'broccoli', 'spinach', 'squash']
...
var fruits = ['strawberries', 'bananas', 'dragonfruit', 'blueberries', 'watermelon', 'cantelope', 'blackberries']
...
// I would think that openTime and closeTime location? city/state? 
...
groceryStore.location = 'Waldorf, MD';